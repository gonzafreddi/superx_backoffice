...
export type InventoryApi = { listInventory(filters?: InventoryFilters): Promise<InventoryItem[]>; listWarehouses(): Promise<Warehouse[]>; createMovement(input: InventoryMovementInput): Promise<InventoryItem>; updateReorderThreshold(itemId: string, threshold: number): Promise<InventoryItem> };
