...
export function validateReceiving(lines: ReceivingLine[], values?: Record<string, Record<string, unknown>>, locationId?: string): { valid: boolean; errors: Record<string, string> };
