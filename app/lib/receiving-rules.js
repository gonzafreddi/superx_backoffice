...
export function validateReceiving(lines, values = {}, locationId = "", requireLocation = true) {
  const errors = {};
  if (requireLocation && !locationId) errors.locationId = "Elegí una ubicación para la recepción.";
  for (const line of lines) {
    ...
    else if (requireLocation && !locationId && !value.locationId) errors[line.purchaseOrderItemId] = "Elegí una ubicación.";
  }
