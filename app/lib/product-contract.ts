...
export type Product = { id: string; slug: string; name: string; description: string; sku: string; barcode: string; categoryId: string; categoryName: string; brandId: string; brandName: string; unit: ProductUnit; imageUrl: string; images: ProductImage[]; active: boolean; updatedAt: string; availableStock?: number; price?: number };
