...
function NavIcon({ name }: { name: string }) {
  ...
  const paths: Record<string, ReactNode> = {
    invoice: <><path {...props} d="M6 3h12v18l-3-2-3 2-3-2-3 2V3Z" /><path {...props} d="M9 8h6M9 12h6M9 16h4" /></>, payment: <><path {...props} d="M3 7h18v11H3z" /><path {...props} d="M3 11h18M7 15h3" /></>, expense: <><path {...props} d="M5 4h14v16H5z"/><path {...props} d="M8 8h8M8 12h8M8 16h4"/></>,
