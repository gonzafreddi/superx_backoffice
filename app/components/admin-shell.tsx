...
const items = [
  ...
  { href: "/ubicaciones", label: "Ubicaciones", icon: "pin" }, { href: "/proveedores", label: "Proveedores", icon: "supplier" }, { href: "/compras", label: "Compras", icon: "purchase" }, { href: "/facturas", label: "Facturas", icon: "invoice" }, { href: "/pagos", label: "Pagos", icon: "payment" }, { href: "/tesoreria", label: "Tesorería", icon: "treasury" }, { href: "/pedidos", label: "Pedidos", icon: "receipt" }, { href: "/entregas", label: "Entregas", icon: "truck" },
];
...
function NavIcon({ name }: { name: string }) {
  ...
  const paths: Record<string, ReactNode> = {
    invoice: <><path {...props} d="M6 3h12v18l-3-2-3 2-3-2-3 2V3Z" /><path {...props} d="M9 8h6M9 12h6M9 16h4" /></>, payment: <><path {...props} d="M3 7h18v11H3z" /><path {...props} d="M3 11h18M7 15h3" /></>,
