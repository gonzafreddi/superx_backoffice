...
const items = [
  ...
  { href: "/precios", label: "Precios", icon: "tag" }, { href: "/inventario", label: "Inventario", icon: "shelves" },
  { href: "/ubicaciones", label: "Ubicaciones", icon: "pin" }, { href: "/proveedores", label: "Proveedores", icon: "supplier" }, { href: "/compras", label: "Compras", icon: "purchase" }, { href: "/pedidos", label: "Pedidos", icon: "receipt" }, { href: "/entregas", label: "Entregas", icon: "truck" },
];
...
function NavIcon({ name }: { name: string }) {
  ...
  const paths: Record<string, ReactNode> = {
    ...
    pin: <><path {...props} d="M20 10c0 5-8 11-8 11S4 15 4 10a8 8 0 1 1 16 0Z" /><circle {...props} cx="12" cy="10" r="2.5" /></>, supplier: <><path {...props} d="M4 7h16v13H4zM8 7V4h8v3M8 12h8M8 16h5" /></>, purchase: <><path {...props} d="M4 5h16v15H4z" /><path {...props} d="M8 3v4M16 3v4M7 11h10M7 15h6" /></>, receipt: <><path {...props} d="M6 3h12v18l-3-2-3 2-3-2-3 2V3Z" /><path {...props} d="M9 8h6M9 12h6" /></>, truck: <><path {...props} d="M3 6h11v10H3zM14 10h4l3 3v3h-7z" /><circle {...props} cx="7" cy="18" r="2" /><circle {...props} cx="18" cy="18" r="2" /></>,
  };
