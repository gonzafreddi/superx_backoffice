...
export function ProductManager() {
  ...
  return <main className="catalog-shell">
    <aside className="sidebar" aria-label="Navegación principal"><div className="brandmark"><span>SX</span><strong>superx</strong></div><nav><a className="nav-item active" href="#productos"><Icon name="box" /> Productos</a></nav><div className="sidebar-footer">Catálogo<br /><small>Backoffice v1</small></div></aside>
    <section className="workspace" id="productos">
